// https://github.com/spring-projects/spring-ai/blob/main/spring-ai-core/src/main/resources/antlr4/org/springframework/ai/vectorstore/filter/antlr4/Filters.g4
grammar Filters;
