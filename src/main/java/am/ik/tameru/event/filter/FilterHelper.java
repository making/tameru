...
public class FilterHelper {
	...
	private final static Map<Filter.ExpressionType, Filter.ExpressionType> TYPE_NEGATION_MAP = Map.of(
			Filter.ExpressionType.AND, Filter.ExpressionType.OR, Filter.ExpressionType.OR, Filter.ExpressionType.AND,
			Filter.ExpressionType.EQ, Filter.ExpressionType.NE, Filter.ExpressionType.NE, Filter.ExpressionType.EQ,
			Filter.ExpressionType.GT, Filter.ExpressionType.LTE, Filter.ExpressionType.GTE, Filter.ExpressionType.LT,
			Filter.ExpressionType.LT, Filter.ExpressionType.GTE, Filter.ExpressionType.LTE, Filter.ExpressionType.GT,
			Filter.ExpressionType.IN, Filter.ExpressionType.NIN, Filter.ExpressionType.NIN, Filter.ExpressionType.IN);
	...
	public static Filter.Operand negate(Filter.Operand operand) {
		...
		if (operand instanceof Filter.Group group) {
			Filter.Operand inEx = negate(group.content());
	 ...
	 */
	public static void expandIn(Filter.Expression exp, StringBuilder context,
			FilterExpressionConverter filterExpressionConverter) {
		Assert.isTrue(exp.type() == Filter.ExpressionType.IN, "Expected IN expressions but was: " + exp.type());
		expandInNinExpressions(Filter.ExpressionType.OR, Filter.ExpressionType.EQ, exp, context,
	 ...
	 */
	public static void expandNin(Filter.Expression exp, StringBuilder context,
			FilterExpressionConverter filterExpressionConverter) {
		Assert.isTrue(exp.type() == Filter.ExpressionType.NIN, "Expected NIN expressions but was: " + exp.type());
		expandInNinExpressions(Filter.ExpressionType.AND, Filter.ExpressionType.NE, exp, context,
				filterExpressionConverter);
	}

	private static void expandInNinExpressions(Filter.ExpressionType outerExpressionType,
			Filter.ExpressionType innerExpressionType, Filter.Expression exp, StringBuilder context,
